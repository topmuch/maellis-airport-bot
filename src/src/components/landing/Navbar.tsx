...
import { Plane, Menu, X, ArrowRight, LogIn, LayoutDashboard } from 'lucide-react'
...
export function Navbar() {
  ...
  const goToDashboard = useCallback(() => {
    setMobileOpen(false)
    window.location.href = '/?showLanding=false'
  }, [])
              ...
              {status === 'loading' ? null : isLoggedIn ? (
                <>
                  ...
                  <button
                    ...
                    className="hidden md:inline-flex items-center gap-2 text-sm font-medium text-slate-300 hover:text-white px-4 py-2.5 rounded-xl border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all"
                  >
                  ...
                  <button
                    ...
                    className="hidden md:inline-flex items-center gap-2 text-sm font-medium text-slate-400 hover:text-red-400 px-3 py-2.5 rounded-xl hover:bg-white/5 transition-all"
                  >
                    Déconnexion
                  </button>
                </>
                ...
                {status === 'loading' ? null : isLoggedIn ? (
                  <>
                    <motion.button
                      ...
                      onClick={goToDashboard}
                      className="flex items-center justify-center gap-2 text-sm font-medium text-slate-300 hover:text-white px-4 py-3.5 rounded-xl border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all"
                    >
                      <LayoutDashboard className="w-4 h-4" />
                      Tableau de bord
                    </motion.button>
                    <motion.button
                      ...
                      onClick={handleLogout}
                      className="flex items-center justify-center gap-2 text-sm font-medium text-slate-400 hover:text-red-400 px-4 py-3.5 rounded-xl hover:bg-white/5 transition-all"
                    >
                      Déconnexion
                    </motion.button>
                  </>
