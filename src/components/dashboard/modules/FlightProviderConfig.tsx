...
export function FlightProviderConfig() {
  ...
  useEffect(() => {
    const fetchConfig = async () => {
      try {
      const result = await apiClient.get<FlightProviderConfigData>('/api/admin/config/flight-provider')
  ...
  const handleTestConnection = useCallback(async () => {
    ...
    try {
      const result = await apiClient.post<TestResult>('/api/admin/config/flight-provider/test')
      ...
      if (result.success) {
        ...
        setTestResult({ success: false, message: result.error || 'Erreur inconnue' })
        setTestStatus('error')
      }
    } catch {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await apiClient.post('/api/admin/config/flight-provider', body)
